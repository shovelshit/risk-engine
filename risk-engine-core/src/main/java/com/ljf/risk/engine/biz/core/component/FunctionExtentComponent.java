...
import com.ljf.risk.engine.biz.core.task.FunctionTask;
import com.ljf.risk.engine.biz.core.task.Task;
import com.ljf.risk.engine.biz.executor.ParallelExecutor;
...
public class FunctionExtentComponent extends AbstractComponent<Long, FunctionExtend> {
    ...
    private final com.ljf.risk.engine.biz.core.component.FunctionComponent functionComponent;

    private final ThreadPoolTaskExecutor asyncThreadPoolTaskExecutor;

    public FunctionExtentComponent(FunctionExtentService functionExtentService, com.ljf.risk.engine.biz.core.component.FunctionComponent functionComponent, ThreadPoolTaskExecutor asyncThreadPoolTaskExecutor) {
